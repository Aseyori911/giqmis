    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-[50px]">
          <h3 className="text-3xl font-bold text-gray-800 mb-[15px]">Why Choose GIQMIS?</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[30px] w-[90%] mx-auto">
          {features.map(({ emoji, title, description }) => (
            <div key={title} className="bg-[#ECECE8] p-[30px] rounded-lg text-center hover:-translate-y-[10px] transition-transform">
              <div className="text-[40px] text-orange-500 mb-5">{emoji}</div>
              <h4 className="text-xl text-gray-800 mb-[15px]">{title}</h4>
