    ...
    <section className="py-20 bg-white dark:bg-stone-900 transition-colors">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-slate-800 dark:text-stone-100 mb-4">Our Core Values</h3>
          <p className="text-slate-500 dark:text-stone-400 max-w-2xl mx-auto">The principles that guide our approach to education and community building.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-[80%] mx-auto">
          {coreValues.map(({ emoji, title, description }) => (
            <div key={title} className="text-center p-8">
              ...
              <h4 className="text-xl text-slate-800 dark:text-stone-100 mb-4">{title}</h4>
