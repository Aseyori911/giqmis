    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto">The principles that guide our approach to education and community building.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-[80%] mx-auto">
          {coreValues.map(({ emoji, title, description }) => (
            <div key={title} className="text-center p-8">
              ...
              <h4 className="text-xl text-slate-800 mb-4">{title}</h4>
