...
const DEFAULT_PROGRAMS: Program[] = [
  ...
  { id: "Arabic_Revision", label: "Arabic Revision", active: true },
  ...
  { id: "Hafdh", label: "Hafdh", active: false },
  { id: "Hadith", label: "Hadith", active: false },
  {
    id: "Lessons from the Quran",
    label: "Lessons from the Quran",
    active: false,
  },
