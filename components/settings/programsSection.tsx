  ...
  return (
    <Section title="Active Programs" icon={<BookOpen size={15} className="text-green-700" />}>
      <p className="text-sm text-stone-500 mb-3">
        Only active programs will appear in the enrollment form. Add new courses or remove outdated ones.
      </p>
      ...
      {adding ? (
        <div className="space-y-2">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-stone-300 rounded-lg text-sm outline-none focus:border-green-500 focus:ring-1 focus:ring-green-200"
            />
            <button
              onClick={handleAdd}
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 border border-dashed border-stone-300 rounded-lg text-sm text-stone-500 hover:border-green-500 hover:text-green-700 hover:bg-green-50 transition-colors w-full justify-center">
