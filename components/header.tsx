...
import LanguageThemeSwitch from "./languageThemeSwitch"

export default function Header() {
  return (
    <div>
      <header className="bg-white dark:bg-stone-900 shadow-sm fixed top-0 left-0 right-0 z-50 transition-colors">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 flex justify-center items-center relative">
                <Image src="/Gladtidings_LOGO.JPG" alt="Glad" fill
                  style={{ objectFit: "cover" }} sizes="48px"
