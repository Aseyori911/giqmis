import { ImageIcon, Newspaper, Mail, BellRing, Heart } from "lucide-react";
      ...
      {tabs.map((t) => (
        ...
        >
          ...
          {t.badge != null && t.badge > 0 && (
            <span
              className={`${t.badgeColor} text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none`}
            >
              {t.badge}
            </span>
          )}
