      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 dark:text-stone-400 max-w-2xl mx-auto">
            These are real students whose education was made possible through the kindness of our sponsors.
          </p>
          <div className="bg-orange-500 w-[10%] mx-auto mt-3 h-1"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map(({ initials, name, program, year, color, quote }) => (
            <div key={name}
              ...
              <p className="text-slate-600 dark:text-stone-400 text-sm leading-relaxed -mt-4">
                {quote}
              </p>
              ...
              <div className="flex items-center gap-3 mt-auto pt-4 border-t border-gray-100 dark:border-stone-700">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 dark:text-stone-500">{program} · Class of {year}</p>
                </div>
              </div>
            </div>
          ))}
