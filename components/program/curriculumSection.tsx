    ...
    <section className="py-20 bg-white dark:bg-stone-900 transition-colors">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-slate-800 dark:text-stone-100 mb-4">Our Curriculum</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center w-[80%] mx-auto">
          <div>
            <h3 className="text-2xl font-bold text-slate-800 dark:text-stone-100 mb-5">
          ...
          <div className="rounded-lg overflow-hidden shadow-xl">
            <Image
              ...
              alt="Students learning Arabic" width={500} height={500}
