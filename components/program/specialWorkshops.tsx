  ...
  return (
    <section className="py-20 bg-white dark:bg-stone-900 transition-colors">
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* Workshop cards */}
        <div className="mb-10">
          <h3 className="text-lg font-bold text-slate-700 dark:text-stone-200 mb-5 flex items-center gap-2">
            📚 Available Workshops
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {w.workshops.map((workshop, i) => (
              <div key={i}
                className="bg-stone-50 dark:bg-stone-800 rounded-xl border border-stone-200 dark:border-stone-700 p-5 hover:border-orange-300 hover:shadow-md transition-all duration-200">
        ...
        {/* Enroll options */}
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-stone-800 dark:to-stone-800 rounded-2xl border border-orange-200 dark:border-stone-700 p-8 mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            ...
            <div className="text-center">
              <p className="text-sm font-bold text-slate-700 dark:text-stone-200 mb-2">
              ...
              <button onClick={onEnroll}
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:opacity-90 text-white rounded-lg font-semibold text-sm transition-opacity">
        ...
        {/* Benefits */}
        <div className="bg-stone-50 dark:bg-stone-800 rounded-xl border border-stone-200 dark:border-stone-700 p-6">
